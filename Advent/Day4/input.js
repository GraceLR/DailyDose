...
const realBoardsFunc = input => {
    let res = [];
    input.forEach((_arr, i) => {
        if(i > 0 && (i + 1) % 5 === 0) {
            res.push([input[i - 4], input[i - 3], 
...
const realBoards = realBoardsFunc(input);

module.exports = { testDraw, testBoards, realDraw, realBoards };